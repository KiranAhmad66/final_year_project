...
import UploadProposalForm from "../component/uploadproposalform/uploadproposalform";
          ...
          <form className="proposals-form" onSubmit={handleSubmit}>
            <div className="proposals-form-container ">
              ...
              <div className="proposals-form-button-container">
                {proposalError ? (
                  <Button type="button" text="Proceed" disabled={true} />
                ) : (
                  <Button type="button" text="Proceed" disabled={false} />
                )}
                {optionError && (
