...
import DefenseProjectPopUp from "../defenseprojectpopup/defenseprojectpopup";

const ProjectDetail = ({ project, status }) => {
    ...
    <div className="view-proposal">
      <div className="view-proposal-head">
        <div className="view-proposal-heading">
          <h3 className="view-proposal-heading-text">
            {status === "Mid" ? "View Mid Project" : "View Final Project"}
          </h3>
        </div>
      </div>
      {loading ? (
        ...
        <>
                              ...
                              <div>
                                {item.Student && item.Student.length === 1 ? (
                                  <p className="view-proposal-student">
                                    {item.Student.length} Students are in group
                                  </p>
                                ) : (
                                  <p className="view-proposal-student">
                                    {item.Student && item.Student.length}{" "}
          ...
          {view && <DefenseProjectPopUp item={Item} sTatus={status} />}
        </>
      )}
    </div>
  );
