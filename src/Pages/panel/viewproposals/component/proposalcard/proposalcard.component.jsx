import "./proposalcard.styles.scss";
...
import ViewProposalPopUp from "../viewproposalpopup/viewproposalpopup";

const ProposalCard = ({ proposal, status }) => {
    ...
    <div className="view-proposal">
      ...
      {loading ? (
        ...
        <>
          ...
          {view && <ViewProposalPopUp item={Item} sTatus={status} />}
        </>
      )}
    </div>
  );
